...
config.vm.define "repo" do |repo|
  ...
  repo.vm.provision :shell, :inline => "yum install https://dl.fedoraproject.org/pub/epel/epel-release-latest-8.noarch.rpm -y; sudo yum install -y https://rpm.pbone.net/info_idpl_78995057_distro_redhatel8_com_sshpass-1.06-9.el8.x86_64.rpm.html;sudo yum install -y python3-pip python3-devel httpd vsftpd createrepo", run: "always"
